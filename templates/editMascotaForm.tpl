            ...
            {foreach from=$dataMascota item=$infoMascota}
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control w-50 ms-2" type="text" aria-label="default input example"
                        name="nombrePaciente" value="{$infoMascota->Nombre}">
                </div>
                <div class="mb-3">
                    ...
                    <input class="form-control w-50 ms-2" type="text" aria-label="default input example" name="especie"
                        value="{$infoMascota->Especie}">
                </div>
                <div class="mb-3">
                    <label for="staticBorn" class="col-sm-2 col-form-label ms-2">Nacimiento</label>
                    <input class="form-control w-50 ms-2" type="text" aria-label="default input example"
                        name="nacimientoPaciente" value="{$infoMascota->Nacimiento}">
                </div>
                ...
                <div class="mt-2 mb-3 ">
                    ...
                    <input class="form-control w-50 h-100" type="date" name="fecha_ingreso"
                        value="{$infoMascota->FechaIngreso}">
                </div>
