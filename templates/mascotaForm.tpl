...
<form method="POST" action="{BASE_URL}agregarMascota">
    ...
    <h1 style="text-shadow: 2px 2px 3px grey">Nuevo Paciente</h1>
                    ...
                    <label for="staticEmail" class="col-sm-2 col-form-label mt-2 mb-3">Complementarios</label>
                        <div>
