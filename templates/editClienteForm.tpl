            ...
            {foreach from=$dataCliente item=$infoCliente}
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control w-50 ms-3" type="text" aria-label="default input example"
                        name="nombre_apellido" value="{$infoCliente->NombreApellido}">
                </div>
                {if $infoCliente->Dni == 0}
                    <div class="mb-3">
                        <label for="staticName" class="col-sm-2 col-form-label ms-3">Dni</label>
                        <input class="form-control w-50 ms-3" type="text" aria-label="default input example" name="dni"
                            value="-">
                    </div>
                {else}
                    <div class="mb-3">
